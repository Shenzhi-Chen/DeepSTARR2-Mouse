...
X_train_sequence, X_train_seq_matrix, X_train, Y_train = prepare_input(fold, "training", output, remove_no_ov=False,balanced_negative=False)
X_valid_sequence, X_valid_seq_matrix, X_valid, Y_valid = prepare_input(fold, "validation", output, remove_no_ov=False,balanced_negative=False)
X_test_sequence, X_test_seq_matrix, X_test, Y_test = prepare_input(fold, "test", output, remove_no_ov=False,balanced_negative=False)
